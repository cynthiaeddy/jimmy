  ...
  return (
    <section className='aboutJim'>
      ...
      <div className='jim left'>
        ...
        <div className='jimCap'><h5>clockwise from top left: caption goes here something this long maybe to fill this space another line</h5></div>
